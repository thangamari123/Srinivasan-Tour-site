...
src_dir = r'public/images/temp-kerala'
...
for f in files:
    if os.path.isfile(f):
        ...
        new_images.append(f'/images/kerala-tour-8-days/{sanitized}')

# Cleanup temp dir
shutil.rmtree(src_dir, ignore_errors=True)

print(f'Processed {len(new_images)} images for Kerala tour.')
...
if idx != -1:
    ...
    print('Error: Could not find kerala-tour-8-days package')

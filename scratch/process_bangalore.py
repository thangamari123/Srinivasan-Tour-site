...
src_dir = r'public/images/temp-bangalore'
target_dir = r'public/images/bangalore-dharmasthala-tour-7-days'
...
for f in files:
    if os.path.isfile(f):
        ...
        new_images.append(f'/images/bangalore-dharmasthala-tour-7-days/{sanitized}')

shutil.rmtree(src_dir, ignore_errors=True)

print(f'Processed {len(new_images)} images for Bangalore Dharmasthala tour.')
...
pkg_id = 'bangalore-dharmasthala-tour-7-days'
    ...
    if img_start != -1:
        ...
        if img_end != -1:
            ...
            with open(pkg_file, 'w', encoding='utf-8') as f:
                f.write(content)
            print('Successfully updated packages.ts for bangalore-dharmasthala-tour-7-days!')
        else:
            print('Error: Could not find end of images array')
    else:
        print('Error: Could not find images array start')
else:
    print('Error: Could not find bangalore-dharmasthala-tour-7-days package')
